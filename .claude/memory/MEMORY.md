...
- [Mode share tự serve dist-web (không Vite proxy)](bow-share-modes-serve-static.md) — QC/Collab/BA/Reviewer/DevOps chạy BOW_SERVE_STATIC=true, client vào THẲNG cổng API (4001…); Vite proxy làm mọi LAN thành 127.0.0.1=admin (lỗ hổng đã vá). Client dùng cổng API, KHÔNG còn 517x
